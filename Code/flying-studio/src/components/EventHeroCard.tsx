    ...
    >
      ...
      <div className="p-6 sm:p-7">
        <div className="flex items-center justify-between gap-3">
          <h3 className="text-lg tracking-wide text-white/90">{item.title}</h3>
          <span className="text-[11px] tracking-[0.22em] text-[#b59a5a]">
            EVENT
          </span>
        </div>
        ...
        {item.cta_link && item.cta_label && !isExpired && (
          <div className="mt-5">
            <Link
              href={item.cta_link}
              className="inline-flex items-center justify-center rounded-2xl border border-[#b59a5a]/50 px-5 py-3 text-sm tracking-[0.18em] text-[#b59a5a] hover:bg-[#b59a5a]/10 transition"
            >
              {item.cta_label}
            </Link>
          </div>
