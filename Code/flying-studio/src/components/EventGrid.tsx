        ...
        return (
          <Link
            ...
            className={[
              ...
              "focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#b59a5a]/60 focus-visible:ring-offset-0",
            ].join(" ")}
            aria-label={it.title}
          >
            {/* Image */}
            ...
            <div className="flex items-center justify-between gap-2 px-3 py-3">
              ...
              <div className="shrink-0 text-[10px] tracking-[0.22em] text-[#b59a5a]">
